...
A streamlined LaTeX lecture notes manager built with Electron.

Lectron bridges the gap between a `.tex` editor and an IDE, focusing specifically on project structure.

<img width="1920" height="1200" alt="thumbnail" src="https://github.com/user-attachments/assets/14a455da-1654-48d3-b255-badc40eb0803" />
